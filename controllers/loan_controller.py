...
from funcoes_secundarias import validar_data, input_int
...
class LoanManager(BookController, UserManager):
    ...
    def adicionar_loan(self):
        ...
        book_id = input_int("Digite o ID do livro que será emprestado: ")
        ...
        #Verificacao_Users
        user_id = input_int("Digite o ID do usuário que pegará o livro: ")
        ...
        SET is_available = %s 
        WHERE id = %s;"""
        query_select_id = "SELECT id FROM Loans WHERE book_id = %s;"
    ...
    def devolver_livro(self):
        ...
        query_loan_check = "SELECT id FROM Loans WHERE id = %s;"
